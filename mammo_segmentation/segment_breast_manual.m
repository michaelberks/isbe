function [breast_border, breast_air, errorcheck] = segment_breast_manual(mammo_fig, mammo, breast_border, breast_air, mammo_name, debug_mode)
...
if exist('mammo_fig', 'var') && ishandle(mammo_fig)
    figure(mammo_fig);
...
while errorcheck
    ...
    if strcmpi(answer, 'yes')
        ...
        while ~points_ok
            ...
            if length(xi) ~= 2
                warndlg({['You selected ' num2str(length(xi)) ' point(s) instead of 2 point'];...
