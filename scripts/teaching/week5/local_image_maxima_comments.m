function [maxima_pos, maxima_vals] = local_image_maxima_comments(image_in, exclusion_zone, mask, threshold)
...
%Threshold the image and combine with the mask
...
[maxima_y maxima_x] = ind2sub([rows cols], maxima_idx);
...
if nargout > 1
    maxima_vals = image_in(maxima_idx(sorted_idx(keep_idx)));
end
