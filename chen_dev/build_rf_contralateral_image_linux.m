function [] = build_rf_contralateral_image_linux(image_num)
%
...
image_dir = '/data/zchen/contralateral/';
...
forest_args.sampling_method = 'sample_contralateral_image';
...
forest_args.tree_dir = ['/data/zchen/contralateral_image_rfs/image_pair', zerostr(image_num, 3), '/'];

forest_args.save_path = ['/data/zchen/contralateral_image_rfs/image_pair', zerostr(image_num, 3), '/random_forest.mat'];

forest_args.do_err = 1;

forest_args.n_trees = 50;


%build forest
[random_forest abnormal_roi_abnormalvotes normal_roi_abnormalvotes abnormal_roi_totalvotes normal_roi_totalvotes] = mb_random_forest_image_train(forest_args);
