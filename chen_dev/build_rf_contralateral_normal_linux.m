function [] = build_rf_contralateral_normal_linux(image_num)
%
...
forest_args.tree_dir = ['/data/zchen/contralateral_normal_26July_rfs/image_pair', zerostr(image_num, 3), '/'];

forest_args.save_path = ['/data/zchen/contralateral_normal_26July_rfs/image_pair', zerostr(image_num, 3), '/random_forest.mat'];

forest_args.do_err = 0;
