function [training_data training_labels parameters] = sample_training_data_allsubbands_pixelset(varargin)
%
...
while true %reaching num_samples is checked below, loop terminates with a return statement
    ...
    %     bg_idx = ceil(6130*rand); %% 6130 bg pathces
    bg_idx = ceil(10460*rand); %% 10460 bg pathces
