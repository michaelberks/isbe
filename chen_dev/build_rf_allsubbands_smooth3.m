function [] = build_rf_allsubbands_smooth3(JOB_ID, TASK_ID, n_samples, n_trees, d)
%
...
sampling_method_args.width_range = [2 16];
sampling_method_args.win_size = 3;

%set up arguments for main forest
forest_args.sampling_method = 'sample_training_data_allsubbands_pixelset_smooth';
