function [] = build_rf_chen(JOB_ID, TASK_ID, n_samples, n_trees, d)
% 
...
if strcmpi(computer,'PCWIN') |strcmpi(computer,'PCWIN64')
    ...
    sampling_method_args.bg_dir = [rfroot_chen, 'normal_smooth128\'];
    % the path of parameters which is used to create the triaing images
    sampling_method_args.save_path = [rfroot_chen, 'rf_trees_', int2str(rfroot_index), filesep];
...
forest_args.sampling_method = 'sample_training_data_max';
