function [] = build_rf_allsubbands_pixelset1_max(JOB_ID, TASK_ID, n_samples, n_trees, d)
%
...
if strcmpi(computer,'PCWIN') |strcmpi(computer,'PCWIN64')
    ...
    sampling_method_args.bg_dir = [rfroot_chen, 'smooth512x512_patches\train\'];
     % Maximum response cross all levels   
    sampling_method_args.do_max = 1;
    ...
    forest_args.parameters_dir = ['rf_trees_', int2str(JOB_ID), '\rf_centre_', zerostr(TASK_ID,2), '_parameters\'];
