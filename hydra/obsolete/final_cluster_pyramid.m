function final_cluster_pyramid(data_name)
...
final_cluster_args.FinalFile = [mberksroot, 'background/results/pyramid/',data_name,'_model'];
final_cluster_args.ResultsDir = [mberksroot, 'background/results/pyramid/',data_name,'/'];
final_cluster_args.MaxFinalMemory = 256;
final_cluster_args.Dimensions = 27;
