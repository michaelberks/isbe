function compute_rf_pair_classification_mb(idx, data_type, n_trees)
...
mammo_dir = [asymmetryroot 'data/mammograms/2004_screening/' data_type '/mat/']; %
seg_dir = [asymmetryroot 'data/segmentations/2004_screening/' data_type '/']; %
...
forest_args.tree_dir = [asymmetryroot 'data/contralateral_images_binary/', data_type, '/'];

forest_args.save_path = [asymmetryroot 'data/contralateral_images_binary/', data_type, '/random_forest', zerostr(idx, 3), '.mat'];
...
forest_args.tree_dir = [asymmetryroot 'data/contralateral_images_binary/', data_type, '/nag/'];
forest_args.save_path = [asymmetryroot 'data/contralateral_images_binary/', data_type, '/nag/random_forest', zerostr(idx, 3), '.mat'];
display('NAG code');
mb_random_forest_two_images_a(forest_args);

forest_args.tree_dir = [asymmetryroot 'data/contralateral_images_binary/', data_type, '/mat/'];
forest_args.save_path = [asymmetryroot 'data/contralateral_images_binary/', data_type, '/mat/random_forest', zerostr(idx, 3), '.mat'];
display('Matlab code');
mb_random_forest_two_images(forest_args);
