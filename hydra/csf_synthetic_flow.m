...
args = u_packargs(varargin,... % the user's input
    ...
    'flow_metrics_dir',	unixenv('FLOW_PARAMS_DIR', 'syn_flow_params'),...
    'plot',             0);
...
for i_rpt = 1:10
    ...
    save([flow_params_dir vessel_name '_rpt' zerostr(i_rpt, 2)], ...
        'vessel_contrast', 'max_flow', 'speckle_noise');

    %Compute flow estimates  
    flow_results = [];
    [flow_results.flowPyramidEst, flow_results.flowConfidence] = ...
        estimate_flow_multilevel(255*frames, [], [], 1:3);
