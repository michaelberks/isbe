function train_CompressedBreast_RF_model_Example_VDM_PC()
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% 
% 
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
training_labels((train_size*number_of_samples+1):end)=2;
        ...
        intcounter=0; 
            for i=1:length(ListOfCancerImages)
                if ~isempty(strfind(ListOfCancerImages{i},['-VDM-DT_CWT_Example_nos_' int2str(number_of_samples) '_init_' int2str(init) '.mat'])) 
...
%                     new_cancer_fold_indx(intcounter)=i; 
            ...
            for i=1:length(ListOfControlImages)
                if ~isempty(strfind(ListOfControlImages{i},['-VDM-DT_CWT_Example_nos_' int2str(number_of_samples) '_init_' int2str(init) '.mat'])) 
                    intcounter=intcounter+1; 
