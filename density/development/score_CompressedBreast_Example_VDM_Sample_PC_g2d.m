function score_CompressedBreast_Example_VDM_Sample_PC_g2d()
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% 
% 
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
...
% assign the decomposition arguments for gaussian derivatives
decomposition_args.decomp_type = {'g2da', 'h2da'}; %Downsampling/Interpolating form of Gaussian derivatives
decomposition_args.win_size = 1;            %Window size about pixel to sample features
decomposition_args.sigma_range = [1 2 4 8 16 32];     %Gaussian sigma at each level (e.g (1:num_levels)^2;)
...
disp('RF model loaded');           
 ...
 for i=1:length(D84ImageList)
        ...
        for int_cntr=1:length(ind_vec)
          ...
          [Y_hat, votes, prediction_per_tree] = classRF_predict(sampled_features, RF_model, test_options);
          RF_votes=votes;
