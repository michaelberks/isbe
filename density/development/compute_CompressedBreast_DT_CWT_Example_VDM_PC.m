function compute_CompressedBreast_DT_CWT_Example_VDM_PC(initpath)
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% 
...
%         end
        ...
        % PC
        cd (DT_CWT_VDM_Path); 
        save([maskName '-VDM-DT_CWT_Example_nos_' int2str(number_of_samples) '_init_' int2str(init) '.mat'], 'sampled_features','generator_status');
