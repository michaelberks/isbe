function mb_single_dual_tree_oris2(varargin)
...
cluster_model.Mean = mean([data1 data2 data3 data4 data5 data6]);
cluster_model.CovMats{1} = mb_cov([data1 data2 data3 data4 data5 data6]);
