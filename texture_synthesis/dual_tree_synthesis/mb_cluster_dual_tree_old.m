function mb_cluster_dual_tree_old(varargin)
...
%get real data using cluster indices;
data_args.Real = 1;
[data_real] =...
    mb_get_dual_tree_subband_data(data_args);
%get imag data using cluster indices;
data_args.Real = 0;
[data_imag] =...
    mb_get_dual_tree_subband_data(data_args);

args.ClusteringFunctionArgs.Data = [data_real data_imag];
...
mem_per_sample = 2*(WindowSize^2 + WindowSize2^2) * size_of_data_element;
