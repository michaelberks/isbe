function [synthesised_image, dual_tree, cluster_image] = mb_gmm_dual_tree_synthesis_cls(varargin)
%
...
for level = args.CutOffLevel:-1:1
    ...
    syn_args.PathToTextureGMM = ...
        [args.ModelDir, args.ModelName, '_', num2str(level)];
    
    if exist([syn_args.PathToTextureGMM, '_cls_0.mat'], 'file') &&...
            exist([syn_args.PathToTextureGMM, '_cls_1.mat'], 'file')
        ...
        syn_args.ClsMap = args.ClsMap{level};
