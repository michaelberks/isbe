function [synthesised_bands cluster_image] = mb_gmm_tex_synthesis_frog(varargin)
%
...
for band = 1:6
    ...
    upper_bands{band}(setdiff(args.PixelOrder, find(args.MaxIdx==band))) = complex(NaN, NaN);
end
