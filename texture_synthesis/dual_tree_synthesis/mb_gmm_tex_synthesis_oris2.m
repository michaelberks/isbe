function [synthesised_image cluster_image] = mb_gmm_tex_synthesis_oris2(varargin)
%
...
synthesised_image{1}(args.PixelOrder) = NaN;
synthesised_image{2}(args.PixelOrder) = NaN;
synthesised_image{3}(args.PixelOrder) = NaN;
synthesised_image{4}(args.PixelOrder) = NaN;
synthesised_image{5}(args.PixelOrder) = NaN;
synthesised_image{6}(args.PixelOrder) = NaN;
