function [synthesised_image cluster_image] = mb_gmm_tex_synthesis2(varargin)
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    
    ...
    if pixel_wise_synthesis
        ...
        sampled_window = (reshape(sampled_window(1:args.WindowSize^2),...
            [args.WindowSize^2 args.WindowSize^2]) * model.Stats.SD) + model.Stats.Mean;
