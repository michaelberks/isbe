function [all_indices, finished_sampling_flag] = mb_next_idx_for_clustering(varargin)
%
...
args = u_packargs(varargin, ... % what the user sent us
			'0', {},... % The optional arguments
            'ImageFiles', [],...
            'ImageDir', [mberksroot, 'background/images/mass'],...
...
if isempty(args.ImageFiles)
    args.ImageFiles = dir([args.ImageDir,'*.bmp']);
end
