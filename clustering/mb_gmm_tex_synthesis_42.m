function [synthesised_image cluster_image] = mb_gmm_tex_synthesis_42(varargin)
%
...
if ~isempty(args.MovieFilename)
    movie = avifile(args.MovieFilename, 'compression', 'none');
end
...
for ii = 1:pixels_to_fill
    ...
    sampled_window(centre_pixel_dim) = NaN;              
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PCA stuff - ignore for now
