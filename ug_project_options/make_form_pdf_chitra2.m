function form_name = make_form_pdf_chitra2(form_idx, reader_id, form_folder, debug_flag)
...
for ii = 1:5
    text(45, 80 + ii*125, ['A' num2str(start_im + ii)]);
    text(85, 80 + ii*125, '0'); 
    text(505, 80 + ii*125, '100');
    text(45, 130 + ii*125, ['B' num2str(start_im + ii)]);
    text(85, 130 + ii*125, '0'); 
    text(505, 130 + ii*125, '100');
end

text(350, bar_r+20, ['Reader ID: ', num2str(reader_id)]);%
text(350, bar_r+45, 'Reading Model II: Side-by-side Assessment');%
...
if debug_flag
    ...
    %Print to pdf
    form_name = [form_folder 'reader' num2str(reader_id)  '_2_' zerostr(form_idx, 2) '.pdf'];
