function [density_percent form_type form_idx reader_id debug_out] =...
    read_chitra_form(image_in, debug_flag)
...
barcode_orig = [340 0; 410 0; 340 29; 410 29];

[box boy] = meshgrid(340:410, 1:30);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
barcode_bin = imresize(barcode, [1 15]);
...
reader_bin = barcode_bin(2:6);
form_type_bin = barcode_bin(7:9); 
form_bin = barcode_bin(10:14); 

%Convert the binary numbers back to decimal numbers
reader_id = 0;
for ii = 4:-1:0
    reader_id = reader_id + reader_bin(5-ii)*2^ii;
end

form_type = 0;
for ii = 2:-1:0
    form_type = form_type + form_type_bin(3-ii)*2^ii;
end

form_idx = 0;
for ii = 4:-1:0
    form_idx = form_idx + form_bin(5-ii)*2^ii;
end

%if debug_flag
    display(['Form type: ' num2str(form_type), ' Form index: ', num2str(form_idx) ' Reader ID: ' num2str(reader_id)]);
%end
...
if form_type == 1
    ...
    line_scale_orig = [ 101 300; 500 300;...
                        101 400; 500 400;...
                        101 500; 500 500;...
                        101 600; 500 600;...
                        101 700; 500 700];
elseif form_type == 4
    num_lines = 10;
    %start and end points for the 4 line-scales
    line_scale_orig = [ 101 210; 500 210;...
                        101 260; 500 260;...
                        101 335; 500 335;...
                        101 385; 500 385;...
                        101 460; 500 460;...
