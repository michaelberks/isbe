...
%--------------------------------------------------------------------------
    function initialise_data
        ...
        %randomly order the blobs based on user id
        rand('twister', 200+user_data.user_id);
        user_data.blob_order = randperm(number_of_blobs)';
...
%--------------------------------------------------------------------------
    function save_user_data
        ...
        %ID
        filename = [user_path, zerostr(user_data.user_id,2), '_2.mat'];
...
% --------------------------------------------------------------------
    ...
    % Callback to allow us to continue
        ...
        if ismember(user_id, valid_ids)
            filename = [user_path, zerostr(user_id,2), '_2.mat'];
