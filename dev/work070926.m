...
ers_combined = nan;
ers_combined = ers_combined(ones(179,5));
...
ers_indie(idx_large, 2) = er_large.ind.total;
ers_shape(idx_large, 2) = er_large.ind.shape;
ers_tex(idx_large, 2) = er_large.ind.tex;
ers_scale(idx_large, 2) = er_large.com.scale;
ers_combined(idx_large, 2) = er_large.com.total;

ers_indie(idx_r50,3) = er_r50.ind.total;
ers_shape(idx_r50,3) = er_r50.ind.shape;
ers_tex(idx_r50,3) = er_r50.ind.tex;
ers_scale(idx_r50,3) = er_r50.com.scale;
ers_combined(idx_r50,3) = er_r50.com.total;

ers_indie(idx_r51,4) = er_r51.ind.total;
ers_shape(idx_r51,4) = er_r51.ind.shape;
ers_tex(idx_r51,4) = er_r51.ind.tex;
ers_scale(idx_r51,4) = er_r51.com.scale;
ers_combined(idx_r51,4) = er_r51.com.total;

ers_indie(idx_u1, 5) = er_u.ind.total;
ers_shape(idx_u1, 5) = er_u.ind.shape;
ers_tex(idx_u1, 5) = er_u.ind.tex;
ers_scale(idx_u1, 5) = er_u.com.scale;
ers_combined(idx_u1, 5) = er_u.com.total;
...
%%
% Similar to above but ratio errors with random models
%%
