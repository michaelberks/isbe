...
function [pyr,pind] = mb_buildSFpyrLevs(lodft,log_rad,Xrcos,Yrcos,angle,ht,nbands)
...
%  log_rad = log_rad + 1;
  ...
  lodft = lomask .* lodft / 4;
  
  [npyr,nind] = mb_buildSFpyrLevs(lodft, log_rad, Xrcos, Yrcos, angle, ht-1, nbands);
