function mb_cluster_gp_cls(varargin)
...
cluster_idx = get_cluster_idx(...
    args.PyramidsDir, args.CLSDir, args.Level, args.WindowSize,...
...
function all_indices = get_cluster_idx(...
    pyr_dir, cls_dir, level, window_size, max_memory, overlap, window_size2, cls_mode)
...
for ii = 1:number_of_pyrs
    ...
    if cls_mode
        ...
        %image map to take inverse of cls map
        sampled = ~sampled;
    end
