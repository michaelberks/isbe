function [y_fit, nodes] = pt_tree_predict(tree, X, return_probs)
%PT_TREE_PREDICT Non-recursive tree prediction
...
%
% See also: MB_CLASS_TREE_TREE CLASSREGTREE, MB_TREE_PREDICT
%
% Created: 15-Oct-2009
