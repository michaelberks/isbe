function [tree] = prune_tree(varargin)
%PRUNE_TREE prunes a classification/regression tree as specified
%   [] = prune_tree(varargin)
%
% PRUNE_TREE uses the U_PACKARGS interface function
...
%
% Notes:
%   T2 = PRUNE_TREE(T1,'level',LEVEL) takes a decision tree T1 and a pruning
...
%
%   T2 = PRUNE_TREE(T1,'nodes',NODES) prunes the nodes listed in the NODES
...
%
%   T2 = PRUNE_TREE(T1) returns the decision tree T2 that is the full,
