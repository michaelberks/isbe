function [predictor] = random_forest_class_train(varargin)
%RANDOM_FOREST_CLASS_TRAIN given input data and a set of class labels,
%builds a random forest for classification
%   [predictor] = random_forest_class_train(varargin)
%
...
%
% Example: [predictor] = random_forest_class_train('X', X, 'y', y);
%
...
%
% See also: TREE_CLASS_TRAIN RANDOM_FOREST_CLASS_PREDICT
%
% Created: 13-Oct-2009
...
for ii = start_tree:n_trees
    ...
    tree = tree_class_train(X, y, tree_args); clear X y;
    clear X y;
    ...
    if ~isempty(X_test)
        ...
        [y_tree] = tree_predict(tree, X_test);
