function [tree] = tree_class_train(X, y, varargin)
%TREE_CLASS_TRAIN given input data and set of class labels, construct a
%single classification tree
%   [tree] = tree_class_train(X, y, varargin)
%
% Inputs:
...
%
% In addition TREE_CLASS_TRAIN uses the U_PACKARGS interface function
...
%
% Example: [tree] = class_tree_train(X, y)
%
% Notes: This function is a implementation adopted from the Matlab function
%   CLASSREGTREE. However TREE_CLASS_TRAIN allows more flexibility in
...
%
% See also: TREE_PREDICT CLASSREGTREE RANDOM_FOREST_CLASS_TRAIN
%
% Created: 13-Oct-2009
