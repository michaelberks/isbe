function [image_out, label, label_centre, label_orientation] =...
    create_sin_step(halfwidth, contrast, orientation, row, col, centre_x, centre_y)
%
