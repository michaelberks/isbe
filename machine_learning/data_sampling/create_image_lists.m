...
args = u_packargs(varargin, ...
   ...
   {'image_root', ...
    ...
    'image_set', {'image','fov_mask','fg_mask','ori','width', 'class_label'}, ...
...
if ~isempty(args.precomputed_indices_dir),
    args.image_set{end+1} = 'precomputed_indices';
end
...
for fields = {'image', 'fg_mask', 'fov_mask', 'ori', 'width', 'class_label',...
              'probability', 'ori_est', 'width_est', 'precomputed_indices'}
    fieldname = fields{1};
