function save_mass_training_data(varargin)
...
if ~exist([args.save_dir args.abnormal_data], 'dir')
    mkdir([args.save_dir args.abnormal_data]);
end
if ~exist([args.save_dir args.normal_data], 'dir')
    mkdir([args.save_dir args.normal_data]);
end

save_radial_data(...
    'save_path', [args.save_dir args.abnormal_data '/' args.save_name],...
    ...
    'mammo_list', abnormal_list(1:num_images));

save_radial_data(...
    'save_path', [args.save_dir args.normal_data '/' args.save_name],...
    ...
    'sigma_range', args.sigma_range,...
    'angular_res', args.angular_res,...
    'mammo_list', normal_list(1:num_images));
