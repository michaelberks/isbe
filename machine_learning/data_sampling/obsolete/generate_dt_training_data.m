function [training_data training_labels parameters] = generate_dt_training_data(varargin)
%
...
if ~isempty(args.pca);
    ...
    switch args.feature_shape
        ...
        case 'clock'
            size_sample_vector = (args.win_size+1)*args.num_levels*num_bands*num_features;
            
            %**** obsolete code previously used for polar13 representation ***
            %switch args.feature_type
            %    case {'real', 'phase'}    
