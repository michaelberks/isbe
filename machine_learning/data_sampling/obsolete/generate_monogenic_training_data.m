function [training_data training_labels parameters] = generate_monogenic_training_data(varargin)
%
...
min_wavelength = args.min_wavelength; %number of levels of DT-CWT from which to extract coefficients
onf = args.onf; %
...
while true 
    ...
    patch_idx = image_idx * ones(1, win_size^2) + ...
        ones(num_samples_image,1)*...
        (kron((win_idx*row), ones(1,win_size)) + repmat(win_idx, 1, win_size));
