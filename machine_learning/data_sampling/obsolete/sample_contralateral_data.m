function [training_data training_labels test_data test_labels] = sample_contralateral_data(varargin)
%
...
[training_data(1:num_train,:) test_data(1:num_test,:)] = ...
