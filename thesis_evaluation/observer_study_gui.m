...
mass_path = 'C:\isbe\dev\observer_study\masses\';
user_path = 'C:\isbe\dev\observer_study\user_data\user';
mass_files = dir('C:\isbe\dev\observer_study\masses\*.mat');
...
% --------------------------------------------------------------------
    ...
    % 
        ...
        mass_ROI = u_load([mass_path, mass_files(user_data.ratings(curr_mass,1)).name]);
        set(ui.region,...
            'Visible', 'on',...
            'CData', mass_ROI,...
            'XData', [1 axes_pos(3)],...
...
% --------------------------------------------------------------------
    ...
    %           
        %load in the new mass and display
        mass_ROI = u_load([mass_path, mass_files(user_data.feedback(curr_mass,1)).name]);
        set(ui.region,...
            'Visible', 'on',...
            'CData', mass_ROI,...
            'XData', [1 axes_pos(3)],...
