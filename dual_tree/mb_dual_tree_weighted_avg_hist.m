function [bin_counts] = mb_dual_tree_weighted_avg_hist(data, bin_edges, phase_dims, mag_dims)
...
for p1 = 1:num_bins1
    for p2 = 1:num_bins2
        ...
        %Take sum of the nominated magnitudes for these points, divided by
        %the number of points i.e. compute the mean sum of magnitudes for
        %each bin
        bin_counts(p1, p2) = sum(mean(data(idx, mag_dims)));
