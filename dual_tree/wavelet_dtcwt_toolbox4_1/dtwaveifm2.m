function Z = dtwaveifm2(Yh, end_level, biort, qshift, gain_mask)
...
%    
%     Yl -> The real lowpass image from the final level (now saved in end
%     cell of Yh)
...
%
% 
% For example:  Z = dtwaveifm2(Yh,'near_sym_b','qshift_b');
