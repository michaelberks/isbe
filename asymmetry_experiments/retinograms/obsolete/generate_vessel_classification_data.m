function [training_data training_labels] = generate_vessel_classification_data(varargin)
...
for kk = 1:num_images
    ...
    vessel_mask = bwmorph(vessel_mask, 'skel', 'inf');
    ...
    for ch = 1:num_channels
        ...
        switch args.decomp_type
            ...
            case 'pixel'
                ...
                training_data(curr_sample:num_samples_image+curr_sample-1,data_cols) = ...
                        sample_pixel_data(channel, rows, cols, sampling_args);
