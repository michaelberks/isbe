function [] = organisation_maps_gui()
...
if strcmpi(getenv('UserName'), 'mberks')
    ...
    map_dir = 'C:\isbe\asymmetry_project\data\weighted_radial_maps\2004_screening\abnormals\';
else
    mammo_dir = 'E:\asymmetry_project\data\mammograms\2004_screening\abnormals\';
    map_dir = 'E:\asymmetry_project\data\weighted_radial_maps\2004_screening\abnormals\';
end
...
%--------------------------------------------------------------------------
    function create_main_fig
        ...
        ui.distance_slider_text = uicontrol(... 
            'Parent', ui.panel5,... 
            'Style','text',...
            'BackgroundColor', get(ui.panel, 'BackgroundColor'),...
            'FontName', 'Arial',...
            'String', 'Select distance weighting: sigma = 8',...
            'HorizontalAlignment', 'left',...
            'Position', [0 25 text_w 25]); 
        
        ui.distance_slider = uicontrol(... 
            'Style', 'slider',...
            ...
            'Parent', ui.panel5,...
            'Enable', 'off',...
            'Callback', @distance_slider_Callback);
        %---------------------------------------------------------------
        ui.panel6 = uipanel(...
            'Parent', ui.main_fig,...
            'Units', 'pixels',...
        ...
        ui.capture_slider_text = uicontrol(... 
            'Parent', ui.panel6,... 
            'Style','text',...
            'BackgroundColor', get(ui.panel, 'BackgroundColor'),...
            'FontName', 'Arial',...
            'String', 'Select capture range weighting: sigma = 1' ,...
            'HorizontalAlignment', 'left',...
            'Position', [0 25 text_w 25]); 
        
        ui.capture_slider = uicontrol(... 
            'Style', 'slider',...
            'Position', [buff buff text_w+button_w+buff 25],...
            'String', 'Select',...
            'Min', 1,...
            ...
            'Parent', ui.panel6,...
            'Enable', 'off',...
            'Callback', @capture_slider_Callback);
        %---------------------------------------------------------------
        ui.panel7 = uipanel(...
            'Parent', ui.main_fig,...
            'Units', 'pixels',...
