function [merged_with] = post_merge_candidates_c(candidate_xy, candidate_scores, candidate_widths,...
    vessel_prob, dist_thresh_ratio, connect_thresh, n_connect_pts, do_plot)
...
while ~all(merged_with == previous_merged_with)
    ...
    for curr_can = 1:num_cans
        ...
        max_width = max(candidate_widths([curr_can nearest_can]));
        dist_thresh = dist_thresh_ratio*max_width;
