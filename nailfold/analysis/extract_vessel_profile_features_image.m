function [profile_features displacements] = extract_vessel_profile_features(vessel_patch, vessel_centre, outer_edge, inner_edge, varargin)
...
args = u_packargs(varargin,... % the user's input
    ...
    'scale_offsets', [0.5 0.75 1 1.25 1.5],...
...
if isempty(args.max_displacement)
    args.max_displacement = mean_width;
end
    ...
    for i_dis = 1:args.num_displacements
        ...
        for theta_offset = args.theta_offsets
            ...
            profile_features(sample_idx,:) = extract_vessel_profile_features(...
                ...
                theta+theta_offset, args.scale_offsets, displacement);
