function [distal_idx] = select_distal_candidates(candidates_xy, candidate_scores, max_iterations, max_angle, rotate_angle, do_plot)
...
if ~exist('rotate_angle', 'var') || isempty(rotate_angle)
    rotate_angle = 0;
end
...
if rotate_angle
    ...
    candidates_xy = candidates_xy*rot_mat;    
end
...
for i_can = 1:num_candidates
    ...
    tan_vectors = abs(atan(...
        ...
        (candidates_xy(leave_out_idx,1) - candidates_xy(i_can,1)) ));
