...
extract_apex_measures_set(...
    ...
    'plot', 0);
%%
study_dir = 'N:\musculoskeletal\NCM only studies\2 yr data incl marina mark up\';
xls_filename = [study_dir '\all_image_auto_measures(3).xls'];
...
%%
study_dir = 'N:\musculoskeletal\NCM only studies\2 yr data incl marina mark up\';
xls_filename = [study_dir '\all_image_auto_measures(2).xls'];
