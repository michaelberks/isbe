    ...
    switch i_step
        ...
        case 3
            compute_apex_candidate_hogs( ... % the user's input
                ...
                'ori_dir',              args.ori_dir,...
                'width_dir',            args.width_dir,...
                'candidates_dir',       [args.apex_dir '/' args.candidates_dir],...
                'hog_dir',              [args.apex_dir '/' args.candidates_dir '/' args.hog_dir],...
        ...
        case 4
            ...
            predict_apex_candidate_rescore(...
                ...
                'data_dir',             [nailfoldroot 'data/' local_root '/'],...
                'candidates_dir',       [args.apex_dir '/' args.candidates_dir],...
                'rescore_dir',          [args.apex_dir '/' args.candidates_dir '/' args.rescore_dir],...
                'hog_dir',              [args.apex_dir '/' args.candidates_dir '/' args.hog_dir]);
            ...
            compute_apex_candidate_displacements(...
                ...
                'displacement_dir',     [args.apex_dir '/' args.candidates_dir '/' args.displacement_dir],...
                'candidates_dir',       [args.apex_dir '/' args.candidates_dir '/' args.rescore_dir],...
        ...
        case 5
            ...
            select_vessels_from_candidates( ...
                ...
                'data_dir',             [nailfoldroot 'data/' local_root '/'],...
                'class_map',            class_map,...
                'selected_dir',         [args.apex_dir '/' args.candidates_dir '/' args.selected_dir],...
                'displacement_dir',     [args.apex_dir '/' args.candidates_dir '/' args.displacement_dir],...
                'rescore_dir',          [args.apex_dir '/' args.candidates_dir '/' args.rescore_dir],...
        ...
        case 6
            extract_apex_measures_set(...
                ...
                'width_dir',            args.width_dir,...
                'candidates_dir',       [args.apex_dir '/' args.candidates_dir '/' args.rescore_dir],...
                'displacements_dir',    [args.apex_dir '/' args.candidates_dir '/' args.displacement_dir],...
                'selected_dir',         [args.apex_dir '/' args.candidates_dir '/' args.selected_dir],...
                'metrics_dir',          [args.apex_dir '/' args.candidates_dir '/' args.metrics_dir],...
