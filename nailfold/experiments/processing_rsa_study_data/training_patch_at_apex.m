function [all_rf_widths all_gt_widths profile_features model_scores] = training_patch_at_apex(start_i, end_i, do_plot)
...
for i_im = start_i:end_i
    ...
    initialise_aam_candidates([image_dir im_name '.mat'], vessel_width, vessel_ori, candidate_xy, ...
