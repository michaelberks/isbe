#ifndef ncm_scp_handler_h_
#define ncm_scp_handler_h_

#include <vcl_string.h>

#include <nailfold/ncm_server_handler.h>

class ncm_scp_handler : public ncm_server_handler
{
// INTERFACE
...
public:
  ...
  //: Default ctor
  ncm_scp_handler(vcl_string server = "", 
                  vcl_string username = "", 
                  vcl_string password = "");
