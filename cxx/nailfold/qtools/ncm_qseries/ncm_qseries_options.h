...
class ncm_qseries_options : public QDialog
{
  Q_OBJECT

public:
  ncm_qseries_options(ncm_qseries_preferences& preferences,
...
private:
  ...
  ncm_qseries_preferences& current_preferences_;
  ...
  ncm_qseries_preferences new_preferences_;
