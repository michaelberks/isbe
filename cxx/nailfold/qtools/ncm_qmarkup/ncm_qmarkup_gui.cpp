...
#include "ncm_qmarkup_options.h"

//
//:
void nailfold_qmarkup_gui::on_actionDebug_triggered()
{
  int dummy = 0;
}
//
...
void nailfold_qmarkup_gui::on_actionCrash_triggered()
{
  assert(false);
}
...
//
//: Constructor
nailfold_qmarkup_gui::nailfold_qmarkup_gui(ncm_qmarkup_preferences& preferences,
...
//
//: Destructor
nailfold_qmarkup_gui::~nailfold_qmarkup_gui()
{
...
bool nailfold_qmarkup_gui::initialize()
{
...
QString nailfold_qmarkup_gui::windowTitle() const
{
  QString version_string = QString::number(preferences_.version());
  return QString("NCM Markup v" + version_string);
}

bool nailfold_qmarkup_gui::wasConstructed() const
{
  return constructed_;
}

void nailfold_qmarkup_gui::hideScene()
{
...
void nailfold_qmarkup_gui::showScene()
{
  ui.graphicsView->setScene(&scene_);
...
bool nailfold_qmarkup_gui::getSiteName()
{
  int error_code = -1;
...
void nailfold_qmarkup_gui::emptyOutbox()
{
  if (!preferences_.use_remote_server())
    return;
...
void nailfold_qmarkup_gui::pullImagesFromServer()
{
  if (!preferences_.use_remote_server())
    return;
...
void nailfold_qmarkup_gui::pullMarkupFromServer()
{
  if (!preferences_.use_remote_server())
    return;
...
bool nailfold_qmarkup_gui::closeIfFinished()
{
...
void nailfold_qmarkup_gui::setIcons()
{
...
void nailfold_qmarkup_gui::setupImageThread()
{
...
void nailfold_qmarkup_gui::setupStatusbar()
{
...
//
//: Update status bar
void nailfold_qmarkup_gui::updateStatus(const QString& status, 
                                         double progress)
{
...
void nailfold_qmarkup_gui::updateStatusLeft()
{
...
void nailfold_qmarkup_gui::onApexLengthChanged(double apex_width_pixels) 
{
...
void nailfold_qmarkup_gui::setupProgressFrame()
{
...
void nailfold_qmarkup_gui::updateProgressFrame()
{
...
void nailfold_qmarkup_gui::applyImageZoom(ncm_qmarkup_preferences::ImageZoom zoom)
{
  switch (zoom)
  {
    case ncm_qmarkup_preferences::ZoomNoResize:
      // do nothing
      break;
    case ncm_qmarkup_preferences::ZoomFit:
      ui.graphicsView->fit_both();
      break;
    case ncm_qmarkup_preferences::ZoomFitWidth:
      ui.graphicsView->fit_width();
      break;
    case ncm_qmarkup_preferences::ZoomFitHeight:
...
//
//: Apply a specified image zooming to the graphics view
void nailfold_qmarkup_gui::applyVesselZoom(int vessel_index)
{
...
void nailfold_qmarkup_gui::applyUserZoom()
{
...
void nailfold_qmarkup_gui::updateToolbar()
{
...
void nailfold_qmarkup_gui::updateItemVisibility()
{
...
void nailfold_qmarkup_gui::updateContrastControls()
{
...
void nailfold_qmarkup_gui::updateVesselControls()
{
...
void nailfold_qmarkup_gui::updateZoomLimits()
{
...
void nailfold_qmarkup_gui::updateZoomControls()
{
...
void nailfold_qmarkup_gui::updateHelpPanel()
{
...
void nailfold_qmarkup_gui::applyAnnotationChange()
{
...
void nailfold_qmarkup_gui::setDefaultPath(vcl_string image_path)
{
...
void nailfold_qmarkup_gui::updateRowButtons(int selected)
{
...
void nailfold_qmarkup_gui::on_prevRow_clicked()
{
...
void nailfold_qmarkup_gui::on_nextRow_clicked()
{
  // Alias for convenience
  QButtonGroup*& radioGroup = rowRadioGroup_;
...
void nailfold_qmarkup_gui::updateSizeButtons(int selected)
{
  const bool selected_is_first = (selected == 0);
...
void nailfold_qmarkup_gui::on_prevSize_clicked()
{
  // selected should never be zero, as the button should be disabled in this
  // instance
...
void nailfold_qmarkup_gui::on_nextSize_clicked()
{
...
void nailfold_qmarkup_gui::updateShapeButtons(int selected)
{
  const bool selected_is_first = (selected == 0);
...
void nailfold_qmarkup_gui::on_prevShape_clicked()
{
  // selected should never be zero, as the button should be disabled in this
  // instance
...
void nailfold_qmarkup_gui::on_nextShape_clicked()
{
  // selected should never be zero, as the button should be disabled in this
  // instance
  int selected = shapeRadioGroup_->checkedId();
...
void nailfold_qmarkup_gui::updateStageControls()
{
...
void nailfold_qmarkup_gui::on_prevStageButton_clicked()
{
...
void nailfold_qmarkup_gui::on_nextStageButton_clicked()
{
...
void nailfold_qmarkup_gui::updateImageControls()
{
...
void nailfold_qmarkup_gui::on_prevImage_clicked()
{
...
void nailfold_qmarkup_gui::on_nextImage_clicked()
{
  // Scene edit mode is changed (without warnings) if the image is
  // successfully loaded. Apply warnings here, before the image is loaded.
  const bool dismiss_warning = warnOnEditModeChange();
...
void nailfold_qmarkup_gui::on_unmarkedCheckbox_toggled(bool checked)
{
...
//
//: Toolbar actions
void nailfold_qmarkup_gui::on_actionPan_triggered()
{
  ui.graphicsView->usePanMode();
}
void nailfold_qmarkup_gui::on_actionLabelImage_triggered()
{
  ui.graphicsView->useMarkupMode();
  requestEditModeChange(ncm_qscene::ModeClassifyImage);
}
void nailfold_qmarkup_gui::on_actionAddVessels_triggered()
{
  ui.graphicsView->useMarkupMode();
  requestEditModeChange(ncm_qscene::ModeAddVessels);
}
void nailfold_qmarkup_gui::on_actionDefineVesselSize_triggered()
{
  ui.graphicsView->useMarkupMode();
  requestEditModeChange(ncm_qscene::ModeSetVesselSize);
}
void nailfold_qmarkup_gui::on_actionDefineVesselShape_triggered()
{
  ui.graphicsView->useMarkupMode();
  requestEditModeChange(ncm_qscene::ModeSetVesselShape);
}
void nailfold_qmarkup_gui::on_actionLabelApices_triggered()
{
  ui.graphicsView->useMarkupMode();
  requestEditModeChange(ncm_qscene::ModeLabelApices);
}
void nailfold_qmarkup_gui::on_actionDrawVesselPath_triggered()
{
  ui.graphicsView->useMarkupMode();
  requestEditModeChange(ncm_qscene::ModeDrawVesselPath);
}
void nailfold_qmarkup_gui::on_actionAddHaemorrhages_triggered()
{
  ui.graphicsView->useMarkupMode();
...
//
//:
void nailfold_qmarkup_gui::on_applySizeToAll_clicked()
{
...
void nailfold_qmarkup_gui::on_applyShapeToAll_clicked()
{
  // FIXME
...
void nailfold_qmarkup_gui::updateVesselList()
{
...
//
//: Select nothing
void nailfold_qmarkup_gui::clearVesselListSelection()
{
...
void nailfold_qmarkup_gui::on_firstVesselButton_clicked()
{
...
void nailfold_qmarkup_gui::on_prevVesselButton_clicked()
{
  const int nVessels = markup_.n_distal();
  const int currentIndex = ui.vesselCombo->currentIndex();
...
void nailfold_qmarkup_gui::on_nextVesselButton_clicked()
{
  const int nVessels = markup_.n_distal();
  const int currentIndex = ui.vesselCombo->currentIndex();
...
void nailfold_qmarkup_gui::on_lastVesselButton_clicked()
{
  const int nVessels = markup_.n_distal();
...
//  Zoom controls
//
void nailfold_qmarkup_gui::setZoomFrom(int value)
{
...
void nailfold_qmarkup_gui::on_zoomSlider_sliderMoved(int value)
{
  setZoomFrom(value);
}

void nailfold_qmarkup_gui::on_zoomEdit_editingFinished()
{
...
void nailfold_qmarkup_gui::on_zoomOutButton_clicked()
{
...
void nailfold_qmarkup_gui::on_zoomInButton_clicked()
{
  // Avoid calling functions that generate more signals, such as this:
  //ui.zoomSlider->setValue(ui.zoomSlider->value()+ui.zoomSlider->pageStep());
...
void nailfold_qmarkup_gui::on_hidePanelButton_clicked()
{
...
bool nailfold_qmarkup_gui::warnOnEditModeChange()
{
...
void nailfold_qmarkup_gui::requestEditModeChange(int newMode)
{
...
void nailfold_qmarkup_gui::on_scene_editModeChanged(int edit_mode)
{
...
void nailfold_qmarkup_gui::on_scene_mouseMoved(double x, double y)
{
...
// Events
//
void nailfold_qmarkup_gui::closeEvent(QCloseEvent *ev)
{
...
void nailfold_qmarkup_gui::getThumbnails()
{
...
void nailfold_qmarkup_gui::onThumbnail_clicked(vcl_string filename)
{
  // Scene edit mode is changed (without warnings) if the image is
  // successfully loaded. Apply warnings here, before the image is loaded.
  const bool dismiss_warning = warnOnEditModeChange();
...
bool nailfold_qmarkup_gui::deleteBackup() const
{
...
bool nailfold_qmarkup_gui::loadImageFrom(vcl_string image_filename)
{
  ...
  currentImagePath_ = vul_file::dirname(image_filename);
  ...
  // get thumbnail images from same folder
  //getThumbnails();

  // Start new image in 'Grade Image' mode
  applyAnnotationChange();
  scene_.set_edit_mode(0); // Warnings can be skipped here
  updateImageControls();
  updateStatusLeft();
...
bool nailfold_qmarkup_gui::loadImageDialog()
{
  // get filename from dialog box
	QString selfilter;
	QString fileName = QFileDialog::getOpenFileName(
    this, "Load image", currentImagePath_.c_str(),
...
void nailfold_qmarkup_gui::on_actionLoadImage_triggered()
{
  loadImageDialog();
}
...
bool nailfold_qmarkup_gui::saveMarkupDialog()
{
...
int nailfold_qmarkup_gui::saveMarkup()
{
...
void nailfold_qmarkup_gui::on_actionSaveMarkup_triggered()
{
  saveMarkup();
  closeIfFinished();
}
...
bool nailfold_qmarkup_gui::saveIfModified()
{
...
void nailfold_qmarkup_gui::on_actionPreferences_triggered()
{
  ncm_qmarkup_options optionsWindow(preferences_, this);
  optionsWindow.exec();
...
void nailfold_qmarkup_gui::on_actionWhatsThis_triggered()
{
  QWhatsThis::enterWhatsThisMode();
}

void nailfold_qmarkup_gui::on_actionHelp_triggered()
{
...
void nailfold_qmarkup_gui::on_brightnessSlider_sliderMoved(int value)
{
...
void nailfold_qmarkup_gui::on_contrastSlider_sliderMoved(int value)
{
...
void nailfold_qmarkup_gui::on_compSizeSlider_sliderMoved(int value)
{
...
void nailfold_qmarkup_gui::on_compSizeSlider_sliderReleased()
{
  imageProcessor_.get_line_pixels();
}

void nailfold_qmarkup_gui::on_deleteAllVessels_clicked()
{
...
void nailfold_qmarkup_gui::on_deleteAllHaemorrhages_clicked()
{
  // Prompt before doing anything
  QMessageBox msgBox;
...
void nailfold_qmarkup_gui::setGrade(int grade_index)
{
  markup_.image_grade().set_value(grade_index);
}

void nailfold_qmarkup_gui::updateGridSpacing()
{
  // Update grid spacing
  const double gridSpacingPixels = 
    preferences_.grid_pixels_per_mm() * preferences_.grid_spacing_mm();
...
void nailfold_qmarkup_gui::on_graphicsView_viewModeChanged(int)
{
  updateStageControls();
  updateToolbar();
  updateHelpPanel();
...
void nailfold_qmarkup_gui::onImageProcessor_imageLoaded(bool success)
{
...
void nailfold_qmarkup_gui::createModeActionGroup()
{
...
void nailfold_qmarkup_gui::createGradeRadioGroup()
{
...
void nailfold_qmarkup_gui::createRowRadioGroup()
{
...
void nailfold_qmarkup_gui::createSizeRadioGroup()
{
...
void nailfold_qmarkup_gui::createShapeRadioGroup()
{
...
void nailfold_qmarkup_gui::applyUserLevelChange()
{
...
void nailfold_qmarkup_gui::updateGradeRadios()
{
...
//  image is 'Undefined').
void nailfold_qmarkup_gui::uncheckGradeRadios()
{
...
void nailfold_qmarkup_gui::connectSignalsToSlots()
{
...
void nailfold_qmarkup_gui::connectSetFocus()
{
