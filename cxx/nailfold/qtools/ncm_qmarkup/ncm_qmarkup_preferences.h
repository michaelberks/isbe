#ifndef __ncm_qmarkup_preferences_h__
#define __ncm_qmarkup_preferences_h__
...
// forward declaration
class ncm_qmarkup_options;

class ncm_qmarkup_preferences
{
  friend ncm_qmarkup_options;
...
#endif // __ncm_qmarkup_preferences_h__