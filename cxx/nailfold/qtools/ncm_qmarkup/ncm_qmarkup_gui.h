...
#include <nailfold/qtools/ncm_qmarkup/ncm_qmarkup_server.h>
//#include <nailfold/qtools/dmk_listener.h>

class nailfold_qmarkup_gui : public QMainWindow
{
  Q_OBJECT

public:
  nailfold_qmarkup_gui(ncm_qmarkup_preferences& preferences,
                       QWidget *parent = 0, Qt::WFlags flags = 0);
  ~nailfold_qmarkup_gui();
...
private:
  ...
  void applyImageZoom(ncm_qmarkup_preferences::ImageZoom zoom);
  ...
  ncm_qmarkup_preferences& preferences_;
