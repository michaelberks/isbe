#ifndef __ncm_qcapture_mosaic_maker_h__
#define __ncm_qcapture_mosaic_maker_h__
...
class ncm_qcapture_mosaic_maker : public QObject, public ncm_mosaic_maker
{
...
signals:
  ...
  void mosaicUpdated(int n_stitched);
  void mosaicFinished(bool success);

public slots:

  //:
  void makeMosaicFrom(const vcl_vector<QPoint> displacements);
...
#endif // __ncm_qcapture_mosaic_maker_h__