#ifndef ncm_qcapture_graphicsview_h_
#define ncm_qcapture_graphicsview_h_
...
class ncm_qcapture_graphicsview : public QGraphicsView
{
  Q_OBJECT
...
public:
  ...
  //: Default constructor
  ncm_qcapture_graphicsview(QWidget* parent = 0);

  //: Destruct
  ~ncm_qcapture_graphicsview();
