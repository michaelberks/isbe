#ifndef __ncm_qfinal_preferences_h__
#define __ncm_qfinal_preferences_h__
...
// forward declaration
class ncm_qfinal_options;

class ncm_qfinal_preferences
{
  friend ncm_qfinal_options;
...
#endif // __ncm_qfinal_preferences_h__