#ifndef NCM_GAUSSIAN_PATCH_EXTRACTOR_H
#define NCM_GAUSSIAN_PATCH_EXTRACTOR_H
...
#include <nailfold\vil_multiscale_gaussian_2nd_derivative.h>

class ncm_gaussian_patch_extractor
{
  ...
  protected:
		...
		//Sampling box
		ncm_gaussian_patch_extractor::sampling_box box_;

		//Width of finest scale Gaussian kernel
		double sigma_;

		//Number of levels
		unsigned n_levels_;

		//Number of oriented filer responses to select
		unsigned n_angles_;

		//Angle of first sub-band
		double theta_base_;

		//Size of window to extract about each pixel
		unsigned win_sz_;

		//Feature type
		vil_multiscale_gaussian_2nd_derivative::FeatureType feat_type_;
...
#endif NCM_GAUSSIAN_PATCH_EXTRACTOR_H
