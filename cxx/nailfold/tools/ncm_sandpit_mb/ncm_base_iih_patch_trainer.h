#ifndef NCM_BASE_IIH_PATCH_TRAINER_H
#define NCM_BASE_IIH_PATCH_TRAINER_H
...
class ncm_base_iih_patch_trainer
{
  private:
    ...
    public:
      ...
      ncm_base_iih_patch_trainer();
      ~ncm_base_iih_patch_trainer();
      
      //
			void generateTrainingData(const vgl_point_2d<double> & apex_centre_xy);
			void generateClassData(const vgl_point_2d<double> & apex_centre_xy, const double class_label);
