#include "ncm_flow_estimator_vxl.h"
...
//:
ncm_flow_estimator_vxl::ncm_flow_estimator_vxl()
{
}
 
void ncm_flow_estimator_vxl::set_image_stack(
...
void ncm_flow_estimator_vxl::set_image_stacks(
  vcl_vector< vil_image_view<float> > const& image_stack,
...
void ncm_flow_estimator_vxl::set_robustifier(
...
void ncm_flow_estimator_vxl::estimate(
  ncm_flow_field& flow_field,
  bool update)
{
  ncm_flow_cost_function_vxl func(
    image_stack_,
    warped_image_stack_,
    robustifier_);
  ...
  int result = sparselm_dercrs(
    &ncm_flow_cost_function::f, 
    &ncm_flow_cost_function::crs_jacobian,
    parameter_vector, 
    /* observations = */ NULL,
    n_parameters, 
